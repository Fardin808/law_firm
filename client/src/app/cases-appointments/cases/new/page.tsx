...
export default function NewCasePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      ...
      setError("Please enter a valid Total Charge.");
      return;
    }
    ...
    try {
      ...
      router.push("/cases-appointments/cases");
      router.refresh();
    } catch {
        ...
        <div className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Create a case from an existing appointment.
            </p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-0.5 text-[10px] text-slate-400">
                  Select an appointment and enter case-specific information.
                </p>
                ...
                <>
                  ...
                  <div className="mb-5 flex flex-col gap-3 rounded-lg border border-slate-200 bg-[#f8fafb] px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div>
                      ...
                      <p className="mt-0.5 text-[10px] text-slate-400">
                        Set whether this case should be active or inactive.
                      </p>
                        ...
                        {appointments.length === 0 && (
                          <div className="mt-2 rounded-lg border border-amber-100 bg-amber-50 px-3 py-2">
                            ...
                            <p className="text-[10px] leading-4 text-amber-700">
                              No available appointments found. Existing appointments may already be linked to cases.
                            </p>
