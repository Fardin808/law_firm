...
export default function NewEmployeePage() {
  ...
  useEffect(() => {
    const fetchNextEmployeeCode = async () => {
      ...
      try {
        ...
        if (!response.ok) {
          throw new Error(
            data.message || "Failed to generate employee code."
          );
        }
  ...
  const handleSubmit = async (
    ...
    if (!employeeCode) {
      setError("Employee code has not been generated yet.");
      return;
    }
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-[11px] text-slate-400">
                    Choose whether this employee starts as active.
                  </p>
                </div>
              </div>
